...
You might use the dirs class for managing directories in your migrations.
...
$container->set(DirsInterface::class, function() {
    return new Dirs([
...
In you migration class just inject the dirs:
